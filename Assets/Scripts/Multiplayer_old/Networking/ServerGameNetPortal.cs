    ...
    public class ServerGameNetPortal : MonoBehaviour
    {
        ...
        //private void ApprovalCheck(byte[] connectionData, ulong clientId, NetworkManager.ConnectionApprovedDelegate callback)
        {
            ...
            if (connectionData.Length > MaxConnectionPayload)
            {
                ...
                response.Reason = "Max Players limit";
                return;
            }
            ...
            // Debug.Log($"Approval check: {gameReturnStatus} {gameReturnStatus == ConnectStatus.Success} {connectionPayload}");
            if (gameInProgress)
            {
        ...
        public Dictionary<string,PlayerData> GetCurrentClientData()
        {
            return clientData;
        }
        public Dictionary<ulong, string> GetClientIdToGuid()
        {
